...
import com.grg.face.view.LivingFaceCheckCameraView;

public class SingleLivingCameraActivity extends AppCompatActivity {

    private ImageView mFaceIv, mImageView;

    private LivingFaceCheckCameraView mFaceCheckCameraView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_living_camera);
